...
INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_pessoa)
VALUES(1, 'Computação', 'USP', 'joao_pereira', '123', 11);

INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_pessoa)
VALUES(2, 'Física', 'USP', 'erick_gomes', '123', 12);

INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_tutor, id_pessoa)
VALUES(3, 'Biologia', 'Unicamp', 'gabrielle_souza', '123', 2, 13);

INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_tutor, id_pessoa)
VALUES(4, 'Computação', 'USP', 'rita_fisher', '123', 2, 14);

INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_pessoa)
VALUES(5, 'Biologia', 'Unesp', 'bruno_castro', '123', 15);

INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_tutor, id_pessoa)
VALUES(6, 'Física', 'Unicamp', 'guilherme_ribeiro', '123', 5, 16);

INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_tutor, id_pessoa)
VALUES(7, 'Computação', 'Unesp', 'julian_rocha', '123', 6, 17);

INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_pessoa)
VALUES(8, 'Física', 'USP', 'nicole_almeida', '123', 18);

INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_pessoa)
VALUES(9, 'Biologia', 'Unicamp', 'rene_bishop', '123', 19);

INSERT INTO public.usuario
    (id_usuario, area_de_pesquisa, instituicao, login, senha, id_pessoa)
VALUES(10, 'Computação', 'Unesp', 'renan_souza', '123', 20);
